CREATE EXTERNAL TABLE IF NOT EXISTS dws.dws_wcdr (
...
location '/daas/motl/dws/dws_wcdr'; 



alter table dws.dws_wcdr add if not exists partition(day_id='20180503') location '/daas/motl/dws/dws_wcdr/day_id=20180503';