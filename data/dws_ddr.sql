CREATE EXTERNAL TABLE IF NOT EXISTS dws.dws_ddr(
...
location '/daas/motl/dws/dws_ddr'; 



增加分区
alter table dws.dws_ddr add if not exists partition(day_id='20180503') location '/daas/motl/dws/dws_ddr/day_id=20180503';
