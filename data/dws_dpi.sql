CREATE EXTERNAL TABLE IF NOT EXISTS dws.dws_dpi(
...
location '/daas/motl/dws/dws_dpi'; 


alter table dws.dws_dpi add if not exists partition(day_id='20180503') location '/daas/motl/dws/dws_dpi/day_id=20180503';
