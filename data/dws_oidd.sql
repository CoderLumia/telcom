CREATE EXTERNAL TABLE IF NOT EXISTS dws.dws_oidd(
...
location '/daas/motl/dws/dws_oidd'; 




alter table dws.dws_oidd add if not exists partition(day_id='20180503') location '/daas/motl/dws/dws_oidd/day_id=20180503';